...
- `npm.cmd run qa:desktop:launch` launches and quits without manual action.
...
- Future fallback or extension: `npm.cmd run qa:desktop:drag:os`
...
- `npm.cmd run qa:desktop:drag` exists and runs locally.
...
13. Add aggregate `npm.cmd run qa`.
