...
const PROMPT_TO_ARTIFACT_CHECKLIST = [
  ...
  },
  {
    ...
    evidence: "src/main/windowBounds.test.ts through corepack pnpm run check",
    automatedKeys: ["check"],
  ...
  },
  {
    ...
    evidence: "simulation docs and test suite through corepack pnpm run check",
    automatedKeys: ["check"],
  ...
  },
  {
    ...
    evidence: "package, runtime, and storage tests through corepack pnpm run check",
    automatedKeys: ["check"],
    artifactPaths: [
